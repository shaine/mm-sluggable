...
* :blacklist - array of strings which should be considered already used slugs (default - [])

Eg.

  sluggable :title, :scope => :account_id, :key => :title_slug, :method => :to_url, :index => false, :blacklist => ["foo", "bar"]
